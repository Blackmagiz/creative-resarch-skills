...
description: จัดรูปแบบการอ้างอิง (citation) สำหรับงานวิจัยทางศิลปะ รองรับ APA 7, Chicago, MLA, TCI standards พร้อม templates เฉพาะ 10 ประเภท (artwork, exhibition catalog, essay in catalog, performance, oral interview, archival material, TCI Thai journal, film, digital/NFT, music score) ที่ generic citation guide ไม่ครอบคลุม, VERIFY BEFORE FORMAT Iron Rule (DOI/TCI/WorldCat verification), NO AI-GENERATED CITATIONS Iron Rule, Thai romanization (ALA-LC/Royal Institute), และ พ.ศ./ค.ศ. conversion สำหรับ Thai journals. Use when the user asks about "การอ้างอิง", "citation", "บรรณานุกรม", "reference list", "อ้างอิง APA/Chicago/MLA/TCI", "อ้างอิงผลงานศิลปะ", "citing artwork", "citing performance", "citing archival", "citing interview", or needs arts-specific citation formatting. MUST trigger whenever a user needs citation formatting, especially for non-standard arts sources.
license: MIT
metadata:
...
⚠️ **IRON RULE — VERIFY BEFORE FORMAT**: ห้าม format reference ที่ยังไม่ได้ verify ว่า source นั้น exist จริง — ตรวจ Google Scholar / DOI resolver / TCI ก่อนเสมอ

⚠️ **IRON RULE — NO AI-GENERATED CITATIONS**: ห้าม accept หรือ format references ที่ไม่สามารถ trace ได้ถึง original source — AI-generated citation = ❌ ต้องแจ้งผู้ใช้ทันที

⚠️ **IRON RULE — STYLE CONSISTENCY**: เลือก citation style เดียวแล้วใช้ตลอด paper — ห้าม mix styles ระหว่าง sections

⚠️ **IRON RULE — THAI ROMANIZATION**: ชื่อภาษาไทยที่ romanize ต้องใช้ RTGS หรือระบบที่ consistent ตลอด paper — ห้ามสะกดต่างกันในส่วนต่างๆ
...
F1: Source Type Unknown | F2: Incomplete Info | F3: AI-Generated Reference | F4: Non-Standard Arts Sources | F5: Thai-Language Source | F6: Mixed Format | F7: Website/Social Media | F8: Multiple Editions

---

## Shared Resources

- `../shared/cross_agent_quality_definitions.md` — Source Quality Hierarchy (Tier 1-4)
- `../shared/tci_compliance_guide.md` — TCI citation format requirements
- `../shared/handoff_schemas.md` — Citation Package handoff format
...
|---------|-------|--------------|
| 2.0.0 | 2026-05-05 | เพิ่ม Iron Rules (4 rules), failure_paths, shared resources references, version history |
